...
- **2026-02-25**: **마이페이지 및 계정 관리 (v1.2.0)**. 회원이 자신의 활동 내역(Talk)을 확인하고, 프로필(닉네임)을 수정하거나 회원 탈퇴 및 계정 재활성화를 할 수 있는 기능을 구현했습니다.
- **2026-02-27**: **사용자 경험 고도화 (v1.3.0)**. 닉네임 유효성 검사 규칙(1-12자, 한글/영문/숫자 조합)을 강화하고, 페이지 전환 시 스크롤 초기화(ScrollToTop) 및 모바일 UI 가독성을 개선했습니다.
